...
import { addApp, listMyAppVoByPage, listGoodAppVoByPage, deployApp as deployAppApi } from '@/api/appController'
...
const viewWork = (app: API.AppVO) => {
  if (app.deployKey) {
    const url = getDeployUrl(app.deployKey, app.codeGenType)
